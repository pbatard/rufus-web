...
<div id="container">
	...
	<div class="tagline">
		...
		<ul dir="<?= $dir;?>">
			...
			<li><?= $prev_version;?>
				<ul dir="<?= $dir;?>">
					<li><span dir="ltr">Finalize persistent partition support for Debian and Ubuntu <b>[EXPERIMENTAL]</b>:
						<ul dir="<?= $dir;?>">
						...
						<li><span dir="ltr">Important: Persistence and <code>ext</code> formatting support should still be considered <b>EXPERIMENTAL</b> at this stage.</span></li>
						</ul>
					</span></li>
		...
		<div class="footer"><table align="center" dir="<?= $dir;?>" cellspacing="0" cellpadding="0" border="0"><tr>
			<td>Copyright&nbsp;</td><td>©&nbsp;</td><td>2011-2019&nbsp;</td><td><a target="_blank" href="https://pete.akeo.ie">Pete&nbsp;Batard</a></td></tr></table>
